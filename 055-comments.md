...
- **v.72** حُورٌ **مَقْصُورَاتٌ** فِي الْخِيَامِ — Hur, **sheltered** in the pavilions. مَقْصُورَات from root ق-ص-ر — the **same root** as قَاصِرَات in v.56! The first pair has "restrainers of glance" (active, qāṣirāt); the second pair has "the sheltered ones" (passive, maqṣūrāt). Same root, shifted from active devotion to being sheltered/protected. The Hur are not objects of desire but beings in a state of sacred seclusion (الخيام, al-khiyām, pavilions/tents — the same word for the tents of the desert, places of hospitality and shelter).
- **v.72** Keeping "Hur" untranslated. The root ح-و-ر (ḥ-w-r) means to return, to be intensely contrasting (white/black of eyes). In modern contexts, the word resonates with communities at society's margins — those whom Jesus pointed to when he said the tax collectors and prostitutes would enter the Kingdom before the self-righteous (Matthew 21:31). By keeping "Hur" open, the text remains available to all these readings rather than foreclosing them.
...
- جَنَّة (janna) = the hidden place
- جِنّ / جَانّ (jinn/jānn) = the hidden beings (named in vv.56, 74)
- جَنَى (janā) = the harvest of what was hidden (v.54)
- بَطَائِن (baṭā'in) = the inner/hidden linings (v.54)
- عَبْقَرِيّ (ʿabqarī) = crafts of the jinn-place (v.76)
- مُدْهَامَّتَان (mudhāmmatān) = overwhelming depth/darkness (v.64)

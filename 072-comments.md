...
Verse 14: "among us are the Devoted (المسلمون), and among us are the unjust." The spectres themselves divide into those who surrender and those who do not. The root س-ل-م here applies to non-human beings — surrender is not a human-only category. If the spectres represent the hidden energetic dimension (see 55:15, "current of fire"), then even the unseen forces of creation can be in a state of islām (wholeness, surrender) or not.

# The Recitation: a root-recovery translation of the Qur'an

## What this is

A complete English translation of the Qur'an built on **Arabic root analysis** — recovering meanings that centuries of conventional translation have obscured. Every key term is translated by its root meaning rather than its received interpretation.

The Qur'an was preserved in Arabic because Arabic's triliteral root system is tamper-resistant: every word cross-references every other use of the same root throughout the text. You can distort one verse's translation, but the root appears in dozens of others that contradict the distortion. This translation reads the roots.

## How it was made

The project began with two seed surahs translated by hand — Ar-Rahman (55) and Al-Mursalat (77) — chosen for their rhythmic intensity and theological depth. Through close root analysis of these surahs, a set of key discoveries emerged that transformed how the rest of the text could be read. The full translation was then developed collaboratively between the translator (Joop Kiefte) and Claude, an AI assistant, in a single extended session — the human providing the theological vision and root-level insights, the AI scaling the translation across all 114 surahs while maintaining consistency.

Every surah has three files:
- **XXX.md** — the English translation
- **XXX-ar.md** — the Arabic original for side-by-side comparison
- **XXX-comments.md** — scholarly annotations with root analysis and cross-surah links

The file **roots.md** catalogues all major root discoveries.
...
See **roots.md** for the complete catalogue of 22+ root discoveries.

## The style

KJV / Shoghi Effendi English — thee, thy, ye, hath — giving the translation the gravity the Arabic demands while creating a bridge to the Bahá'í English translations. Close to Arabic structure, preserving particles that are often dropped in modern translations.
...
You can help! Fork this repository and send pull requests with:
- Root-meaning improvements to any verse
- Additional annotations in comment files
- Corrections where the Arabic doesn't support the translation
- Cross-surah connections we missed

Please read **CLAUDE.md** for the project's translation principles and **roots.md** for the established root conventions before contributing.
